...
tm_layout(title = "Ventura County Percent Low Income by Tract Boundaries") + 
tm_scalebar() + 
...
tm_layout(title = "Ventura County Air Toxics Cancer Risk (persons per million) by Tract Boundaries") + 
tm_scalebar() + 
